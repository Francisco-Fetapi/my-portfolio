...
const translations: TranslationUseTecnologies = {
  ...
  ts: "Depois do TypeScript já não mais desenvolvo projetos com JavaScript. Antes não queria ouvir falar sobre tipagem, não me agradava em nada, hoje já não vivo sem.",
  reactjs:
