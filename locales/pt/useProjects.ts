...
const translations: TranslationUseProjects = {
  ...
  `,
  july: `Uma landing page contendo informações sobre o
  ...
  chimbanda: `Jornal interno desenvolvido para o <b>Colégio Chimbanda</b>. O sistema
  ...
  forum: `Um projeto de estudo criado para simular um forum de discussões com um
  sistema de publicações, comentários e reações. Foi o meu primeiro
  projeto com <linkReactjs>React</linkReactjs> +
  <linkPhp>PHP</linkPhp> no
  <linkFrontBack>back-end</linkFrontBack>.`,
  gallery: `Um pequeno sistema criado para fazer o upload de imagens. Todas as
